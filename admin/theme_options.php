                            ...
                            <div>
                                ...
                                <table class="admin-module">
                                    <tr>
                                        ...
                                        <td class="admin-module-field">
                                            <select name="ns_core_topbar_first_field">
                                                <option value="email" <?php if(esc_attr(get_option('ns_core_topbar_first_field', 'email')) == 'email') { echo 'selected'; } ?>>Email</option>
                                                <option value="phone" <?php if(esc_attr(get_option('ns_core_topbar_first_field', 'email')) == 'phone') { echo 'selected'; } ?>>Phone</option>
                                                <option value="social" <?php if(esc_attr(get_option('ns_core_topbar_first_field', 'email')) == 'social') { echo 'selected'; } ?>>Social Links</option>
                                                <option value="member" <?php if(esc_attr(get_option('ns_core_topbar_first_field', 'email')) == 'member') { echo 'selected'; } ?>>Member Actions</option>
                                                <option value="" <?php if(esc_attr(get_option('ns_core_topbar_first_field', 'email')) == '') { echo 'selected'; } ?>>None</option>
                                            </select>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div>
                                ...
                                <table class="admin-module">
                                    <tr>
                                        ...
                                        <td class="admin-module-field"><input type="text" name="ns_core_style_global_bg" id="style_global_bg" class="color-field" data-default-color="#ecf2f6" value="<?php echo esc_attr( get_option('ns-core_style_global_bg', '#ecf2f6') ); ?>" /></td>
                                    </tr>
                                </table>
                            ...
                            <div>
                                ...
                                <table class="admin-module">
                                    <tr>
                                        ...
                                        <td class="admin-module-field"><input type="text" name="ns_core_style_top_bar_bg" id="style_top_bar_bg" class="color-field" data-default-color="#48a0dc" value="<?php echo esc_attr( get_option('ns_core_style_top_bar_bg', '#48a0dc') ); ?>" /></td>
                                    </tr>
                                </table>
                            ...
                            <div>
                                ...
                                <table class="admin-module">
                                    <tr>
                                        ...
                                        <td class="admin-module-field"><input type="text" name="ns_core_style_header_text" id="style_header_text" class="color-field" data-default-color="#464646" value="<?php echo esc_attr( get_option('ns_core_style_header_text', '#464646') ); ?>" /></td>
                                    </tr>
                                </table>
                                ...
                                <table class="admin-module">
                                    <tr>
                                        ...
                                        <td class="admin-module-field"><input type="text" name="ns_core_style_header_icon" id="style_header_icon" class="color-field" data-default-color="#59aee9" value="<?php echo esc_attr( get_option('ns_core_style_header_icon', '#59aee9') ); ?>" /></td>
                                    </tr>
                                </table>
                                ...
                                <table class="admin-module no-border">
                                    <tr>
                                        <td class="admin-module-label">
                                            ...
                                            <span class="admin-module-note"><?php echo esc_html_e('*Only for Default Header style', 'ns-core'); ?></span>
                                        </td>
