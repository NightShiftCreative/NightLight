            ...
            <tr>
                ...
                <td class="theme-options-nav-container" valign="top">
                    <ul class="ns-tabs-nav">
                        ...
                        <li><a href="#page-banner" title="<?php echo esc_html_e('Pages & Sidebars', 'ns-core'); ?>"><i class="fa fa-copy"></i> <span class="ns-tab-text"><?php echo esc_html_e('Pages & Sidebars', 'ns-core'); ?></span><div class="clear"></div></a></li>
