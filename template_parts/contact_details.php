<?php
    ...
    $phone = esc_attr(get_option('rypecore_phone'));
    $email = esc_attr(get_option('rypecore_email'));
    $address = esc_attr(get_option('rypecore_address'));
    ...
    <div class="container">
        <div class="center">
            ...
            <div class="contact-item">
                <?php echo rypecore_get_icon($icon_set, 'envelope', '', 'mail'); ?>
                <h4><?php esc_html_e( 'Email Us', 'rypecore' ); ?></h4>
            ...
            <?php if(!empty($phone)) { ?>
            <div class="contact-item">
                <?php echo rypecore_get_icon($icon_set, 'phone', 'telephone'); ?>
                <h4><?php esc_html_e( 'Call Us', 'rypecore' ); ?></h4>
            ...
            <div class="contact-item">
                ...
                <h4><?php esc_html_e( 'Visit Us', 'rypecore' ); ?></h4>
            ...
            <div class="contact-item">
                <?php echo rypecore_get_icon($icon_set, 'share-alt', 'share2', 'forward'); ?>
                <h4><?php esc_html_e( 'Connect With Us', 'rypecore' ); ?></h4>
